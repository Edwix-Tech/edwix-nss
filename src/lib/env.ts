...
export const reloadEnv = () => {
  envRef.current = {
    ...
    SUPABASE_URL_PROMO_STAGING: String(process.env.NEXT_PUBLIC_SUPABASE_URL_PROMO_STAGING),
    SUPABASE_ANON_KEY_STAGING: String(process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY_STAGING),
  };
};
